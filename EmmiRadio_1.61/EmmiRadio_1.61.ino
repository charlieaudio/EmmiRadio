/* -------------------------------------------------------------------------
   EmmiRadio v1.61 – FFat + selectable LCD / OLED display backend
   -------------------------------------------------------------------------
   Main changes from v1.6:
   - restores AP mode after failed manual WiFi connect attempt
   - more accurate Serial network summary
...
void setup(){
  ...
  displayInit();
  displayWake();
  safeLcdPrint("EmmiRadio v1.61","Boot...");
